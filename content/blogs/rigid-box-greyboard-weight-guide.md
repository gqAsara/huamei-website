---
title: "Rigid box greyboard: how core thickness changes structure, feel, and what to specify in the brief"
description: "A material guide to rigid box greyboard — how 1.5 mm, 2.0 mm, and 3.0 mm core thicknesses affect box weight, corner stability, lid travel, and interior dimensions, with guidance on what each tier suits."
slug: "rigid-box-greyboard-weight-guide"
section: "blogs"
primaryKeyword: "rigid box greyboard"
secondaryKeywords:
  - "greyboard thickness rigid box"
  - "rigid box core weight"
  - "luxury rigid box material specification"
  - "greyboard packaging material"
  - "rigid box wall thickness specification"
...
internalLinks:
  ...
  - "/volumes/yangshao"
externalCitations:
  - { url: "https://fsc.org/en", what: "FSC — Forest Stewardship Council, certified sustainable board sourcing" }
  - { url: "https://www.iso.org/standard/54727.html", what: "ISO 4046 — Paper, board, pulp and related terms: vocabulary, the reference standard for packaging board definitions" }
firstPartyData:
  - "Ninety-nine structures on file at Huamei — each specifies a core greyboard thickness at the drawing stage"
  - "Founded 1992; four factories in Henan, Zhejiang, Sichuan, Guizhou"
  - "Hand assembly is the cost driver for true luxury rigid boxes; greyboard weight is the structural cost driver"
  - "Heidelberg and KBA offset presses on-site across the four-factory footprint"
featuredSnippetTarget:
  question: "What greyboard thickness should I use for a luxury rigid box?"
  answer: "A luxury rigid box wall typically uses 1.5 mm to 3.0 mm of greyboard, with 2.0 mm as the cosmetics-industry standard. A 1.5 mm core suits lighter retail boxes; 2.0 mm suits mid-to-premium gifting and cosmetics; 3.0 mm is used for collector-edition spirits and presentation cases where perceived weight is part of the brand brief."
geo:
...
[Wuliangye 68](/volumes/wuliangye-68), a premium spirits case in Huamei's volumes library, uses a heavy-core structure to match the perceived weight of the glass bottle and the premium positioning of the 68 Series. The box must feel as considered as what is inside it.
...
See [/craft/rigid](/craft/rigid) for a full account of how greyboard core, interior lining, and insert interact in the structural drawing. Huamei's ninety-nine on-file structures each carry a specified core thickness, interior lining type, and insert format — all drawn at the same time.
...
[FSC](https://fsc.org/en)-certified greyboard is available for briefs that require the board substrate to carry certification alongside the paper wrap. The certification covers both the structural core and the exterior paper.
