---
title: "How to write a packaging brief: 8 decisions to make before sampling begins"
description: "What a luxury packaging factory needs in a brief before sampling begins — structure, finishes, quantity, artwork format, logistics, and the decisions that, if left open, delay the quote and extend the sample round."
slug: "how-to-write-packaging-brief"
section: "blogs"
primaryKeyword: "how to write packaging brief"
secondaryKeywords:
  - "packaging brief template"
  - "custom packaging brief"
  - "luxury packaging specification"
  - "packaging factory brief"
...
internalLinks:
  ...
  - "/begin"
externalCitations:
  - { url: "https://iccwbo.org/business-solutions/incoterms-rules/", what: "ICC Incoterms 2020 — FOB definition and logistics terms" }
...
Weight matters because it sets the minimum greyboard thickness. A ceramic bottle weighing 900 g requires 2.5–3.0 mm greyboard to carry the load through transit and gift exchange without deforming the corner joints. A 50 g cosmetic compact can run on 1.5 mm board. The factory selects the board weight once it knows the product weight; the brief that specifies it in advance skips a clarification round. See [/craft/rigid](/craft/rigid) for greyboard specification detail.

## Decision 2: Opening structure

Name the opening mechanism: magnetic-closure lift-lid, drawer box (sleeve and tray), telescoping lid-and-base, clamshell, book-style, or other. If the brief cannot name the mechanism, name the opening experience: "slow reveal with both hands" points to a drawer; "one-hand lift access" points to a magnetic closure; "no visible hardware" points to a telescoping base. Ninety-nine structures are on file at Huamei — the fastest briefs name one of those by referencing a volume from the [/volumes](/volumes) library or the [/craft/magnetic](/craft/magnetic) and [/craft/rigid](/craft/rigid) pages.

## Decision 3: Surface finish list

Foil (hot or cold), emboss, deboss, soft-touch lamination, spot UV, offset print, matte or gloss varnish, or combinations of the above. The finish list is the second most common omission after structure — a brief that says "luxury finish" without specifying which techniques requires a discovery call that could have been a one-line specification. The most useful format is a list: "hot foil (warm gold), emboss on logotype, soft-touch matte laminate on outer wrap, no spot UV." See [/craft/hot-foil](/craft/hot-foil) and [/craft/emboss](/craft/emboss) for specification language.
...
Name the destination country and city, and specify the Incoterms: FOB (freight on buyer's account from origin port) or CIF (freight to destination port included). Most US-bound projects from Huamei ship [FOB Shanghai or Ningbo](https://iccwbo.org/business-solutions/incoterms-rules/); most UK and EU projects ship FOB Shanghai. The destination and Incoterms together allow the factory to model the full landed-cost stack: unit price plus freight plus local tariffs and customs. A brief that omits destination cannot be quoted accurately on total landed cost — which is the figure that a brand's MSRP must absorb. [Serenjoy Box LLC](/volumes/serenjoy) is an example of a US-based client whose production runs FOB Ningbo from Huamei's Henan press floor.
...
The brief that names a reference volume from Huamei's [/volumes](/volumes) library — [Man Made Crayon](/volumes/man-made-crayon) for kraft and craft gifting, [Glees Grove](/volumes/glees-grove) for botanical wellness, [Wuliangye 68](/volumes/wuliangye-68) for premium spirits — answers questions about material, structure, and finish register without requiring a separate mood board exchange. The reference narrows the quote to a realistic range before any sampling begins. For [cosmetic](/industry/cosmetic) briefs without a direct volume reference, a competitive product in the same retail environment — a named product at a named retailer — serves the same purpose. Quality runs against the [ISO 9001:2015 standard](https://www.iso.org/iso-9001-quality-management.html). Certification scans at [/house/certifications](/house/certifications).
...
- Huamei production data: 200+ MOQ floor, 7–10 day samples, 15–20 day production, 3–4 weeks US West Coast freight; locked 2026-05-04
- Huamei homepage facts: four factories (Henan, Zhejiang, Sichuan, Guizhou), founded 1992, 99 structures, 17 foils, 80 papers
