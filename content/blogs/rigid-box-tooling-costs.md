---
title: "How rigid box tooling costs work: dies, moulds, and setup at MOQ 200+"
description: "A buyer's guide to tooling costs in custom luxury rigid box manufacturing — covering foil dies, emboss tools, foam die-cuts, moulded pulp tools, and how these one-time setup costs amortise across order volumes from 200 to 5,000 pieces."
slug: "rigid-box-tooling-costs"
section: "blogs"
primaryKeyword: "rigid box tooling costs"
secondaryKeywords:
  - "packaging die cost"
  - "hot foil die setup cost"
  - "custom box tooling"
  - "emboss die packaging"
  - "rigid box setup cost"
...
internalLinks:
  ...
  - "/blogs/box-inserts-luxury-packaging"
...
externalCitations:
  ...
  - { url: "https://iccwbo.org/business-solutions/incoterms-rules/", what: "ICC Incoterms 2020 — risk transfer point for tooling ownership in international orders" }
firstPartyData:
  - "MOQ public floor: 200+ pieces"
  - "Sample lead time: 7–10 days"
  - "Production lead time: 15–20 days"
  - "Foil registration held to ±0.1 mm"
  - "Huamei structure library: ninety-nine structures on file"
  - "Founded 1992, four factories in Henan, Zhejiang, Sichuan, Guizhou"
  - "Hand-assembly is the cost driver for true luxury packaging"
featuredSnippetTarget:
  question: "What tooling costs should I expect when ordering custom rigid box packaging?"
  answer: "Custom rigid box tooling costs cover four categories: a hot-foil brass die (engraved to your artwork geometry, one die per foil colour or emboss element), a foam die-cut tool (for foam inserts cut to your product shape), a moulded pulp tool (a two-sided metal mould for pulp-fibre inserts), and any structural die for non-standard box shapes. Each tool is a one-time cost paid on the first order and reused on all subsequent repeat orders."
geo:
...
[ISO 9001:2015](https://www.iso.org/iso-9001-quality-management.html) quality management covers the tooling fabrication and sample validation process at all four Huamei factories.

Under [Incoterms FOB](https://iccwbo.org/business-solutions/incoterms-rules/), tooling ownership and retention terms should be specified in the purchase order — standard practice at Huamei is that tooling stays in-house for use on repeat orders, and buyers should confirm this arrangement in writing before the first order.

To discuss tooling costs for a specific brief — structure type, decoration intent, and volume — visit [/begin](/begin). Include artwork files or a reference sample and the operations team in Henan will provide a tooling itemisation alongside the unit-cost estimate.
