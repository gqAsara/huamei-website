---
title: "Greyboard grades for luxury rigid box construction — 1.5 mm to 3.0 mm decoded"
description: "Which greyboard thickness makes a luxury rigid box read as luxury vs. industrial. The 1.5–3.0 mm working range, where each thickness fits, and how to spec it on a brief."
slug: "greyboard-grades-for-luxury-rigid-construction"
section: "blogs"
primaryKeyword: "greyboard grades luxury rigid box"
secondaryKeywords:
  - "greyboard thickness rigid packaging"
  - "rigid box board weight spec"
  - "1.5 mm vs 3.0 mm chipboard"
  - "luxury box wall thickness"
...
author:
  ...
  factory: "Henan"
  url: "/house/people"
publishedAt: "2026-05-08T21:00:00+08:00"
...
firstPartyData:
  - "Greyboard working range: 1.5 mm to 3.0 mm"
  - "1.5 mm: slim folding-derived structures, presentation cards"
  - "2.0 mm: house standard for cosmetic rigid boxes"
  - "2.5 mm: magnetic-flap closures, drawer towers"
  - "3.0 mm: spirits, heritage, heavy-lid lift-off"
  - "All grades sourced FSC- or PEFC-certified by default"
firstPartyDataSource: "Discovery interview, 2026-05-04"
featuredSnippetTarget:
  question: "What greyboard thickness is used for a luxury rigid box?"
  answer: "Greyboard for luxury rigid box construction sits between 1.5 mm and 3.0 mm. 1.5 mm is used for slim presentation pieces, 2.0 mm is the house standard for cosmetics, 2.5 mm carries magnetic-flap closures, and 3.0 mm is the heaviest grade — used for spirits and heritage gift packs."
geo:
...
**2.0 mm — the house standard for cosmetics.** Beauty rigid boxes (Collgene, Kefumei and the prestige skincare houses we have on file) sit at 2.0 mm by default. The thickness is enough to feel substantial in the hand, light enough that air-freight cost stays reasonable on a 50,000-piece launch shipment. If a brief does not specify otherwise, 2.0 mm is what we sample.
...
Every greyboard grade Huamei stocks is FSC- or PEFC-certified unless the brand specifies otherwise. The certifications are visible on the [/house/certifications](/house/certifications) page. We do not charge a premium for certified stock; the volumes we run make non-certified stock economically irrelevant.
...
For the full rigid-box build process — how the greyboard skeleton interacts with the wrap, the closure, and the surface decoration — read [custom luxury rigid box manufacturing](/blogs/custom-luxury-rigid-box-manufacturing). For how the closure decision interacts with wall thickness specifically, read [magnetic closure pull-force](/blogs/magnetic-pull-force-explained). The full structural taxonomy lives at [/craft](/craft).

[I want a rigid box like this. →](/begin)
