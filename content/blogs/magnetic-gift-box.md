---
title: "The magnetic gift box: structure, pull-force, and how to order one for retail"
description: "What makes a magnetic gift box work — greyboard weight, closure types, pull-force range (6–50 g at 2,800 Gauss), and the MOQ and lead-time realities for ordering at retail scale."
slug: "magnetic-gift-box"
section: "blogs"
primaryKeyword: "magnetic gift box"
secondaryKeywords:
...
firstPartyData:
  ...
  - "Greyboard: 1.5–3.0 mm; 2.0 mm cosmetic standard"
  - "Hot-foil registration: ±0.1 mm"
  - "Four factories: Henan, Zhejiang, Sichuan, Guizhou. Founded 1992."
featuredSnippetTarget:
  question: "What is a magnetic gift box?"
  answer: "A magnetic gift box is a rigid box closed by embedded neodymium magnets rather than a mechanical latch or tuck flap. Pull-force ranges from 6 to 50 grams at 2,800 Gauss, depending on closure type and greyboard weight. Minimum order is 200 pieces; samples are ready in 7–10 days."
geo:
...
See [/craft/magnetic](/craft/magnetic) for the full closure specification guide, and [/craft/rigid](/craft/rigid) for how greyboard weight is selected by application.
...
**Surface decoration.** [Hot-foil stamping](/craft/hot-foil) at ±0.1 mm registration, emboss, spot UV, or soft-touch laminate — specified in the same brief and applied to the wrap before box assembly.
...
For spirits — a baijiu presenter, a whisky gift set, a limited-edition CNY release — the typical spec is heavier greyboard (2.5–3.0 mm), higher pull-force (30–50 g), and surface decoration that signals occasion: gold or red hot-foil on the lid face, registered emboss on the brand mark. The [Hetao Wang](/volumes/hetaowang) open-face emerald rigid box is an example of a magnetic-closure spirits presenter with full-face surface treatment over deep greyboard.

For cosmetics — a skincare set, a fragrance coffret, a palette outer — the typical spec is 2.0 mm board, 15–25 g pull-force, and a softer surface register: soft-touch laminate over coated art paper, spot UV on the logo, minimal foil. The [Collgene](/volumes/collgene) skincare carton shows how a lighter rigid construction integrates within a product-line system.

Both sectors require [ISO 9001:2015](https://www.iso.org/iso-9001-quality-management.html) quality management across the production run. Huamei holds BSCI, CE, EQS, FSC, and SGS certifications — the [amfori BSCI](https://www.amfori.org/en/tools-and-services/amfori-bsci) audit covers social-compliance requirements for US and EU procurement teams.

## How to order

Send a brief to [/begin](/begin) specifying structure, board weight, pull-force target, and outer wrap. Huamei returns a costing and a sample schedule within three business days. Samples take 7–10 days; production on an approved sample runs 15–20 days.

[Start a brief →](/begin)

## Sources

- Huamei first-party data: pull-force 6–50 g at 2,800 Gauss; ninety-nine structures on file; MOQ 200+ pieces; sample 7–10 days; production 15–20 days (confirmed 2026-05-04)
- ISO 9001:2015 — https://www.iso.org/iso-9001-quality-management.html
- amfori BSCI — https://www.amfori.org/en/tools-and-services/amfori-bsci
