---
title: "Custom packaging boxes: types, structures, and how to order from a manufacturer"
description: "Custom packaging boxes span rigid (1.5–3.0 mm greyboard), folding carton (300–500 gsm board), and collapsible rigid formats. MOQ floor is 200 pieces, samples in 7–10 days, production in 15–20. This guide covers how to choose, specify, and order."
slug: "custom-packaging-boxes-guide"
section: "blogs"
primaryKeyword: "packaging boxes"
secondaryKeywords:
...
updatedAt: "2026-05-16T10:30:00+08:00"
schema: "Article"
internalLinks:
  - "/craft/rigid"
  - "/blogs/paper-boxes-luxury-packaging"
...
The [Collgene](/volumes/collgene) skincare case is a representative example at the lower end of the rigid range — a tuck-end structure in the branded section that shows how rigid construction applies at skincare scale. The [Kefumei](/volumes/kefumei) case shows a mass-plus-premium SKU approach, where two board weights appear in the same product line for different retail tiers.
...
**When to specify a folding carton:** unit economics are a primary constraint, the product ships in secondary packaging, and the box is functional rather than a display object. For a [detailed comparison of rigid vs folding carton formats](/blogs/rigid-box-vs-folding-carton), including the economic crossover points, see the dedicated guide.
...
For a full side-by-side of all three formats including cost, weight, and structural properties, see [Paper boxes for luxury packaging: rigid, folding, and collapsible construction compared](/blogs/paper-boxes-luxury-packaging).
...
**[FSC](https://fsc.org/en)** (Forest Stewardship Council) confirms the paper and board supply chain traces to sustainably managed forests. Required by a growing share of European retailers and increasingly standard in US specialty retail procurement.

**[BSCI](https://www.amfori.org/en/tools-and-services/amfori-bsci)** (amfori Business Social Compliance Initiative) is a social-compliance audit of the factory — labour practices, hours, wages, safety. The most common social-compliance framework for international buyers sourcing from China.
...
To begin a custom packaging box quote, start with the product dimensions, target price point, surface decoration intent, and whether the format is rigid, folding, or collapsible. The [/begin](/begin) page takes these inputs and routes them to the right factory team.

Factories across Henan, Zhejiang, Sichuan, and Guizhou run on >80% solar energy — a supply-chain credential that supports [cosmetic](/industry/cosmetic) and luxury brand ESG commitments for Scope 3 reporting.
