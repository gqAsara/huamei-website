---
title: "Sleeve-and-tray rigid box construction: when to specify it and how it is engineered"
description: "A manufacturing guide to the sleeve-and-tray rigid box — when the structure is the right choice, how it is built at 2.0–3.0 mm greyboard, surface treatment options, transit performance, and what belongs in a production brief."
slug: "sleeve-tray-rigid-box-construction"
section: "blogs"
primaryKeyword: "sleeve tray box"
secondaryKeywords:
  - "sleeve box packaging"
  - "rigid box structures"
  - "tray and sleeve box"
  - "custom sleeve box manufacturer"
  - "rigid sleeve packaging"
intent: "commercial"
wordCount: 1100
author:
  name: "Sonia Sun"
...
externalCitations:
  - { url: "https://www.ista.org/", what: "ISTA — International Safe Transit Association, transit simulation and drop-test protocols for packaging" }
...
This is structurally distinct from a [drawer box](/craft/drawer), where one end of the sleeve is closed and the inner tray pulls from a single direction with a thumb-slot assist. The sleeve-and-tray has both ends of the sleeve open, which means the inner tray can be pushed through from either side — the structure is reversible, which is a consideration for retail display.

The [rigid](/craft/rigid) specification for a sleeve-and-tray typically runs 2.0 mm greyboard for the sleeve walls and 2.0 mm for the tray base and walls. Heavier-duty transit packaging — where the outer sleeve must absorb handling loads during 24-hour transit vibration — may specify 2.5 mm greyboard on the sleeve and 2.0 mm on the tray.
...
Huamei's transit testing for sleeve-and-tray structures includes the 24-hour vibration simulation and the [ISTA](https://www.ista.org/) drop protocol, which tests the structure under the handling loads of parcel-courier and freight-container shipment. The empty-box compression test confirms that a sleeve stack can withstand warehouse palletisation without deforming the sleeve walls. These tests apply to all transit-grade packaging leaving Huamei's four factories.
...
On the sleeve: [hot-foil stamping](/craft/hot-foil) is the primary decorative element, applied to the wrap paper over the sleeve's greyboard core. Registration is held to ±0.1 mm. The [Heritage Tea](/volumes/heritage-tea) red-and-gold-foil sleeve uses a full-coverage gold foil on a red coated art wrap — the foil is applied in a single die pass to the outer face of the sleeve before the sleeve is assembled. The inner face of the sleeve is lined with a plain cream paper.

On the tray: [soft-touch laminate](/craft/soft-touch) on the tray exterior reduces the sliding friction against the sleeve interior and provides a velvet surface that distinguishes the inner object from the outer. The soft-touch surface accepts hot-foil at adjusted die parameters — lower temperature, shorter dwell — relative to a coated art base.
...
"Transit testing for sleeve-and-tray packaging at Huamei covers high 50 °C / low -30 °C environmental exposure, 24-hour vibration simulation, drop, and empty-box compression — the full [ISTA](https://www.ista.org/) protocol set for international parcel and freight shipment."
...
[FSC](https://fsc.org/en)-certified greyboard and wrap papers are available for sleeve-and-tray constructions at Huamei's standard MOQ of 200+ pieces and 15–20 day production cycle.
...
Sample production runs 7–10 days from artwork lock and delivers one assembled sleeve-and-tray unit. Production of 200+ sets follows at 15–20 days from sample sign-off. Start a brief at [/begin](/begin).
