---
title: "Sourcing packaging from China: tariffs, HS codes, and landed-cost for US and EU brands"
description: "A buyer's guide to the practical mechanics of sourcing custom packaging from China — HS classification, current US tariff rates, Incoterms choices, certifications for EU/US procurement, and how to estimate landed cost before requesting a quote."
slug: "sourcing-packaging-china-us-brands"
section: "blogs"
primaryKeyword: "sourcing packaging from China"
secondaryKeywords:
  - "packaging import from China"
  - "packaging HS code"
  - "China packaging tariff"
  - "packaging supplier China certifications"
  - "luxury packaging import cost"
intent: "commercial"
wordCount: 1180
author:
  name: "Sonia Sun"
...
updatedAt: "2026-05-16T11:30:00+08:00"
schema: "Article"
internalLinks:
  - "/house/certifications"
  - "/blogs/packaging-supplier-guide"
  - "/blogs/moq-realities-luxury-packaging"
  - "/industry/cosmetic"
  - "/begin"
externalCitations:
  - { url: "https://www.wcoomd.org/en/topics/nomenclature/overview/what-is-the-harmonized-system.aspx", what: "WCO Harmonized System — international goods classification nomenclature" }
  - { url: "https://iccwbo.org/business-solutions/incoterms-rules/", what: "ICC Incoterms 2020 — international commercial terms for trade" }
...
The [WCO Harmonized System](https://www.wcoomd.org/en/topics/nomenclature/overview/what-is-the-harmonized-system.aspx) (HS) is the international goods classification used by virtually every customs authority. For paper-based packaging, the relevant heading is HS Chapter 48 (paper and paperboard). Within Chapter 48:
...
[ICC Incoterms 2020](https://iccwbo.org/business-solutions/incoterms-rules/) defines who bears cost and risk at each stage of an international shipment. For packaging orders from China, the most common terms are:
...
**[FSC](https://fsc.org/en) chain-of-custody.** Confirms that the paper and board used in production traces to sustainably managed forests. Required by a growing share of European retailers and increasingly expected in US specialty retail. An FSC-certified factory can supply an FSC-labelled box; the brand needs its own FSC trademark licence to print the FSC mark on packaging.

**[BSCI](https://www.amfori.org/en/tools-and-services/amfori-bsci) social compliance.** A factory audit covering labour practices, working hours, wages, and safety. The BSCI report is shared through the amfori platform and accepted by most European brand buyers as a substitute for their own factory audit — at least for initial supplier qualification.
...
Huamei holds BSCI, CE, EQS, [FSC](https://fsc.org/en), and SGS certifications. Full documentation is available for procurement audit packages — see the [certifications page](/house/certifications) for the current certificate scan set.
...
The [packaging supplier evaluation guide](/blogs/packaging-supplier-guide) covers the five capability signals to assess before placing a first order, including how to interpret a factory's certification portfolio and what transit-grade testing documentation looks like.

For a quote on a specific structure and quantity, start at [/begin](/begin). The factory team in Henan can provide an EXW price and a sample timeline from a confirmed brief.
