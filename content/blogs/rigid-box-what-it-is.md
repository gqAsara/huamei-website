---
title: "What is a rigid box: greyboard construction, wall thickness, and ordering guide"
description: "A rigid box is a non-collapsible packaging structure built on a greyboard core. This guide covers board weights (1.5–3.0 mm), wrap materials, decoration options, MOQ of 200+ pieces, and 7–10 day sample turnaround."
slug: "rigid-box-what-it-is"
section: "blogs"
primaryKeyword: "rigid box"
secondaryKeywords:
  - "what is a rigid box"
...
firstPartyData:
  ...
  - "Greyboard wall range: 1.5–3.0 mm"
  - "MOQ: 200+ pieces"
...
featuredSnippetTarget:
  question: "What is a rigid box?"
  answer: "A rigid box is a non-collapsible packaging structure built on a greyboard core between 1.5 mm and 3.0 mm thick, wrapped in coated paper or book cloth and finished with hot-foil, emboss, or laminate. Unlike a folding carton, it ships pre-assembled from the factory."
geo:
...
**Decorative finish.** Applied to the wrap surface after printing. The most common combinations are soft-touch laminate (a matte, velvety hand feel) with [hot-foil stamping](/craft/rigid) for the primary mark, or high-gloss laminate with spot UV for a contrast-gloss effect.
...
A 2.5–3.0 mm wall is standard for spirits and baijiu packaging, where the box may weigh 400–800 grams fully loaded and needs to hold its form through a retail display cycle as well as transit. The [Wuliangye 68](/volumes/wuliangye-68) case is a representative example: a premium rigid set in red and gold that uses 3.0 mm greyboard to match the weight of the bottle.
...
The [Luoyang Dukang](/volumes/dukang) octagonal theatre box uses a variable board weight — heavier on the base to carry the bottle load, lighter on the decorative top panel — a construction technique available when the structure requires it.
...
The factory carries [FSC](https://fsc.org/en) chain-of-custody certification, meaning the paper and board in the supply chain can be traced to sustainably managed forests — a requirement that is increasingly standard in European and North American luxury retail procurement. [ISO 9001:2015](https://www.iso.org/iso-9001-quality-management.html) quality management is also on file.
...
To start a rigid box sample, visit [/begin](/begin) or contact the factory team with the product dimensions and decoration intent.
