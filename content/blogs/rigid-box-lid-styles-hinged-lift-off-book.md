---
title: "Rigid box lid styles: lift-off, hinged, and book-style — when each is right"
description: "A structural guide to the three primary rigid box lid formats — lift-off (two-piece), hinged, and book-style. When to specify each, how each is engineered in greyboard, the unboxing sequence each creates, and how magnetic closures interact with hinged and book formats."
slug: "rigid-box-lid-styles-hinged-lift-off-book"
section: "blogs"
primaryKeyword: "rigid box lid styles"
secondaryKeywords:
  - "hinged lid rigid box"
  - "lift off lid box"
  - "book style rigid box"
  - "rigid box formats compared"
  - "luxury box lid types"
...
author:
  ...
  factory: "Henan"
  url: "/house/people"
publishedAt: "2026-05-23T11:30:00+08:00"
updatedAt: "2026-05-23T11:30:00+08:00"
schema: "Article"
internalLinks:
  - "/craft/rigid"
  - "/craft/hot-foil"
  - "/craft/soft-touch"
  - "/volumes/danquan-cave"
  - "/volumes/tianamen-jiu"
...
firstPartyData:
  ...
  - "Hinge width specification: 3–5 mm for 100–110 degree opening angle"
...
featuredSnippetTarget:
  question: "What is the difference between a lift-off lid, hinged lid, and book-style rigid box?"
  answer: "A lift-off lid box has a separate lid that is removed completely to open. A hinged lid box joins the lid to the base at a spine so the lid opens and stays attached. A book-style box is a hinged format oriented on the short edge, opening like a hardcover book — common in premium spirits gifting in China."
geo:
...
The [Wuliangye Premium Brew clamshell](/volumes/wuliangye-clamshell) demonstrates a clamshell variant of the lift-off concept: two lift-off halves hinged at a central point. This is a specific format for bottle presentation, not a standard lift-off lid, but it shares the same structural logic of complete revelation on opening.
...
Begin a project at [/begin](/begin). Samples run 7–10 days from artwork lock; production at 200+ pieces follows in 15–20 days.
