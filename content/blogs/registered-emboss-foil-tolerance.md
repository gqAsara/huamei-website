...
secondaryKeywords:
  - "emboss foil registration ±0.1 mm"
  - "registered foil packaging spec"
  - "luxury packaging emboss foil tolerance"
  - "dual-pass foil registration"
...
firstPartyData:
  - "Registered emboss-and-foil held to ±0.1 mm at Huamei"
  - "Industry-typical tolerance ~±0.3 mm"
  - "Press operator re-checks registration every 200 sheets"
  - "Single dieline, both layers — emboss outline + foil mark"
  - "Hot-foil: 120–160 °C, dwell 0.4–0.8 s"
firstPartyDataSource: "Discovery interview, 2026-05-04"
featuredSnippetTarget:
  question: "What is registered emboss-and-foil and what tolerance is achievable?"
  answer: "Registered emboss-and-foil is a single mark where the embossed die rises and the foil lights at the same point, in perfect alignment. Achievable tolerance at Huamei is ±0.1 mm, held by re-checking the registration every 200 sheets. Industry-typical is ±0.3 mm."
geo:
...
A factory that holds ±0.1 mm has a written procedure for each of these three sources of drift, runs that procedure on every project, and audits to it. This is what an [ISO 9001:2015](https://www.iso.org/iso-9001-quality-management.html) certification commits to.
...
**[Kefumei](/volumes/kefumei)** is a skincare outer where the foil mark sits inside a sculpted (multi-level) emboss. Sculpted emboss is two dies, not one — the foil pass has to land relative to the deeper die, not the shallow one. The mark holds ±0.1 mm across the production run.
...
For a foil mark inside an embossed boundary with less than 1 mm of distance — the Collgene and Kefumei geometries — ±0.1 mm is the difference between a clean luxury mark and a printed-looking mark.
...
For broader context — the seventeen-foil palette, substrate-pairing rules, when hot-foil is the wrong tool — read [hot-foil stamping for luxury packaging](/blogs/hot-foil-stamping-for-luxury-packaging). For when cold foil is the better choice (it never is for registered work, but worth knowing why), read [hot-foil vs cold foil](/blogs/hot-foil-vs-cold-foil-cost-and-finish).

[I want a registered foil mark like this. →](/begin)
