---
title: "Pantone colour matching on luxury packaging: from brief to press approval"
description: "How colour is matched on luxury rigid boxes — Pantone specification, offset press calibration, foil colour selection, and the approval steps between a colour brief and a signed-off production run."
slug: "pantone-colour-matching-luxury-packaging"
section: "blogs"
primaryKeyword: "pantone matching packaging"
secondaryKeywords:
  - "pantone colour rigid box"
  - "colour management luxury packaging"
  - "packaging colour approval"
  - "offset printing colour match"
  - "pantone foil packaging"
...
externalCitations:
  - { url: "https://www.pantone.com/", what: "Pantone — proprietary colour matching system, PMS reference standard for offset and specialty printing" }
  - { url: "https://www.fogra.org/en/", what: "FOGRA — German printing standards institute, ISO 12647-2 press characterisation data for offset" }
firstPartyData:
  - "Heidelberg and KBA offset presses at Huamei factories"
...
The [Pantone Matching System](https://www.pantone.com/) assigns a unique reference number to each standardised ink colour. On offset press, a Pantone reference can be reproduced either as a spot ink (a pre-mixed proprietary ink, one colour per unit) or as a CMYK build (a combination of cyan, magenta, yellow, and black screens). For luxury rigid box wraps, spot ink reproduction is preferred wherever the colour is critical, because CMYK builds introduce dot-gain variation across the paper surface that is visible at close inspection.

[FOGRA](https://www.fogra.org/en/) publishes the ISO 12647-2 press characterisation data sets that define the expected ink density, dot gain, and colour gamut for offset printing on different paper categories (coated glossy, coated matt, uncoated). Huamei's [Heidelberg](https://www.heidelberg.com/) and KBA presses are profiled against the FOGRA characterisation data for the specific substrate in production — a 128 gsm gloss coated art wrap will have a different press profile than a 150 gsm uncoated textured specialty sheet.
...
Soft-touch laminate, which is applied over the printed surface as a post-print process, shifts the perceived colour a further 3–8% towards the cooler and more muted end of the Pantone range. A [soft-touch](/craft/soft-touch) laminated pack must be proofed after lamination, not before, because the laminate is not a transparent overlay — it is a texture layer that interacts with the light reflecting from the ink beneath.
...
"[Soft-touch](/craft/soft-touch) laminate shifts perceived colour 3–8% towards the cooler and more muted end of the range — proofing must occur after lamination, not before."

Colour-critical packaging briefs begin at [/begin](/begin). Huamei's 7–10 day sample cycle includes a drawdown and a fully assembled sample box for approval before production.
