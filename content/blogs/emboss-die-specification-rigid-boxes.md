---
title: "How to specify an emboss: depth, die type, and registration on luxury rigid boxes"
description: "A craft guide to specifying emboss and deboss on luxury rigid box packaging. Die types (male/female, single-level, multi-level), emboss depth, registration to foil and print, paper response, and what belongs in a complete emboss brief."
slug: "emboss-die-specification-rigid-boxes"
section: "blogs"
primaryKeyword: "emboss specification packaging"
secondaryKeywords:
  - "emboss die specification"
  - "luxury packaging emboss"
  - "registered emboss foil"
  - "deboss rigid box"
  - "emboss depth packaging"
...
externalCitations:
  - { url: "https://www.iso.org/iso-9001-quality-management.html", what: "ISO 9001:2015 — quality management standard governing production process control and tolerance verification" }
  - { url: "https://www.heidelberg.com/", what: "Heidelberg — press equipment manufacturer; Huamei operates Heidelberg offset presses on its packaging lines" }
firstPartyData:
  - "Hot-foil-to-emboss registration held to ±0.1 mm — three times tighter than the industry-typical ±0.3 mm"
  - "Emboss depth range: 0.3–2.0 mm depending on greyboard weight and paper type"
  - "Seventeen curated hot-foil colours for registered emboss applications"
...
**Multi-level die.** Different areas of the embossed mark are at different heights — a central motif sits at 1.5 mm, a surrounding frame at 0.8 mm, a background texture at 0.3 mm. The multi-level die creates a sculptural impression with foreground and background planes, visible from oblique angles. The [Wuliangye Clamshell](/volumes/wuliangye-clamshell) spirits presentation case uses a multi-level emboss on the box lid where the central motif reads at a different plane from the decorative border — a sculptural quality that a single-level die cannot produce.
...
[Heidelberg](https://www.heidelberg.com/) press-integrated emboss stations at Huamei allow in-line registered embossing on some production runs, with the emboss applied in the same machine pass as the offset print. This reduces registration error relative to a separate off-line emboss operation. For combination foil-emboss dies, the emboss is always applied off-line on a dedicated foil-stamping press, which provides the force and temperature control that foil application requires.
...
Production at [ISO 9001:2015](https://www.iso.org/iso-9001-quality-management.html)-governed process control means that every emboss depth and registration measurement is verified at the press sign-off step before the full run proceeds. Huamei's 7–10 day sample cycle delivers a physical box with the emboss at the specified depth for client approval before production of 200+ pieces begins at 15–20 days.

Start an emboss-specification brief at [/begin](/begin).
