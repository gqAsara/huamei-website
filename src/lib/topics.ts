...
const TOPIC_RELATED_BLOGS: Record<string, string[]> = {
  ...
  magnetic: ["halloween-gift-packaging-2026", "mens-grooming-packaging-luxury-rigid-box", "magnetic-gift-box-packaging", "magnetic-box-packaging", "folding-magnetic-box", "magnetic-closure-box-guide", "drawer-box-vs-magnetic-closure-luxury-packaging", "custom-magnetic-box-guide", "custom-luxury-gift-box"],
  ...
  offset: ["packaging-factory-audit-checklist", "pantone-tolerance-luxury-packaging", "screen-printing-vs-foil-stamping-luxury-packaging", "soy-ink-offset-printing-luxury-packaging", "hot-foil-stamping-for-luxury-packaging"],
  wraps: ["fedrigoni-paper-packaging", "gmund-paper-luxury-box", "wibalin-paper-rigid-box", "book-cloth-buckram-rigid-box", "custom-luxury-rigid-box-manufacturing", "greyboard-grades-for-luxury-rigid-construction"],
  // Industries
  cosmetic: ["find-packaging-manufacturer-startup", "supplement-bottle-box-manufacturer", "mens-grooming-packaging-luxury-rigid-box", "refillable-cosmetic-packaging-design", "skincare-set-packaging-manufacturer", "cosmetic-packaging-box", "custom-cosmetic-packaging-box", "perfume-bottle-with-box-packaging", "perfume-box-design-guide", "custom-luxury-gift-box", "rigid-box-cosmetic-brand", "cosmetic-packaging-luxury-rigid-box"],
