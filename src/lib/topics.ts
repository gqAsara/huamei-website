...
const CRAFT_VOLUMES: Record<string, string[]> = {
  ...
  emboss:      ["zhonghua-dragon", "collgene"],
  deboss:      ["yangshao", "glees-grove", "man-made-crayon"],
  "soft-touch":["kefumei"],
  "spot-uv":   ["collgene", "kefumei"],
  offset:      ["t2-tea", "pink-food-sleeve", "heart-window", "lavender-orchid"],
...
const HOT_FOIL: Topic = {
  ...
  related: [
    ...
    { rn: "VIII.",name: "Kefumei",     category: "Skincare", year: 2025, tag: "Mass + premium · Foil",     cover: "/photos/cases/kefumei/01.jpg",  href: "/volumes/kefumei" },
...
const TOPIC_COPY: Record<string, TopicCopy> = {
  rigid: {
    ...
    commercialDescription: "Paper-wrapped rigid boxes for cosmetic, spirits, and gifting brands. 1.5–3.0 mm greyboard core, MOQ 200+ pieces, 20–28 day production. Built for Wuliangye, Yangshao and a small bench of skincare houses.",
    buyerFaq: [
  ...
  magnetic: {
    ...
    commercialTitle: "Luxury packaging magnet pull force — 6–50 g at 2,800 Gauss",
    commercialDescription: "Magnetic closure pull-force: 6–50 g at 2,800 Gauss, calibrated to lid weight. Right closure for any luxury rigid box brief. MOQ 200+, samples 7–10 days.",
    buyerFaq: [
  ...
  cosmetic: {
    ...
    prose: [
      ...
      "Houses on file include Collgene, Kefumei, and a small bench of indie skincare projects. Minimum 1,000 for folding, 300 for rigid. Lead time 14–18 days for cartons, 22–32 days for rigid.",
    ],
    pullQuote: "The compact, the tube, the jar — and everything that sits around them.",
    meta: ["4 in archive", "ΔE ≤ 2", "Soft-touch standard"],
    commercialTitle: "Luxury cosmetic & skincare packaging manufacturer",
    commercialDescription: "Folding cartons, rigid boxes, and magnetic flaps for cosmetic and skincare brands. ΔE ≤ 2 colour, ±0.1 mm foil-to-emboss registration. Built for Collgene, Kefumei and a small bench of skincare brands.",
    buyerFaq: [
...
const TOPIC_RELATED_BLOGS: Record<string, string[]> = {
  // Structures
  rigid: ["tequila-mezcal-luxury-packaging-gift-sets", "press-kit-packaging-launch-box", "collectible-board-game-packaging", "hanukkah-gift-box-packaging-us-brands", "travel-retail-luxury-packaging", "rigid-box-drop-test-standard", "ista-3a-testing-luxury-packaging", "gin-craft-spirits-packaging-rigid-box", "china-national-day-2026-gift-packaging", "hair-care-set-packaging-rigid-box", "korean-beauty-packaging-rigid-box", "sake-japanese-spirits-packaging", "incense-home-fragrance-packaging-rigid-box", "premium-honey-gourmet-food-packaging", "premium-pet-product-packaging", "corporate-gifting-season-2026-rigid-box", "serialised-qr-code-luxury-packaging", "ecommerce-subscription-box-manufacturer", "window-cutout-clear-panel-rigid-box", "luxury-gift-hamper-packaging", "premium-food-brand-luxury-packaging", "rigid-setup-box-wholesale-supplier", "paper-tube-packaging-vs-rigid-box", "two-piece-rigid-box-manufacturer", "rigid-box-manufacturer-china-low-moq", "luxury-rigid-box-price-per-unit", "fsc-certified-rigid-box-supplier", "gift-box-manufacturer-guide", "custom-luxury-rigid-box-manufacturing", "rigid-box-greyboard-weight-guide", "rigid-box-lid-styles-hinged-lift-off-book", "black-friday-gift-packaging-2026", "how-to-read-rigid-box-quotation-china", "christmas-2027-gift-packaging-calendar", "eyewear-sunglasses-gift-box-packaging", "baby-shower-newborn-gift-packaging", "luxury-ceramics-tableware-gift-packaging", "premium-gourmet-food-gift-packaging", "luxury-stationery-gift-packaging", "hand-assembly-luxury-packaging", "shoe-box-footwear-gift-packaging", "book-style-vs-sleeve-tray-rigid-box", "corporate-award-recognition-packaging", "limited-edition-collectible-packaging", "flat-pack-rigid-boxes-export-shipping", "china-luxury-packaging-market-2026", "pre-shipment-quality-inspection-luxury-packaging", "custom-printed-tissue-paper-luxury-packaging", "packaging-brief-calendar-2027-seasonal-launches", "cognac-brandy-gift-box-manufacturer", "multi-color-hot-foil-stamping-rigid-box", "eva-foam-vs-moulded-pulp-insert-comparison", "nfc-smart-packaging-luxury-rigid-box", "laser-cut-decorative-panel-rigid-box"],
  magnetic: ["press-kit-packaging-launch-box", "hanukkah-gift-box-packaging-us-brands", "travel-retail-luxury-packaging", "magnetic-pull-force-explained", "korean-beauty-packaging-rigid-box", "premium-pet-product-packaging", "halloween-gift-packaging-2026", "mens-grooming-packaging-luxury-rigid-box", "magnetic-gift-box-packaging", "magnetic-gift-box", "magnetic-box-packaging", "folding-magnetic-box", "folding-gift-box-magnetic-closure", "magnetic-closure-box-guide", "drawer-box-vs-magnetic-closure-luxury-packaging", "custom-magnetic-box-guide", "custom-luxury-gift-box", "black-friday-gift-packaging-2026", "christmas-2027-gift-packaging-calendar", "eyewear-sunglasses-gift-box-packaging", "baby-shower-newborn-gift-packaging", "flat-pack-rigid-boxes-export-shipping"],
  ...
  folding: ["mailer-box", "folding-gift-box-guide", "folding-magnetic-box", "custom-corrugated-box-manufacturer", "rigid-box-vs-folding-carton", "moq-realities-luxury-packaging", "folding-gift-box-magnetic-closure", "flat-pack-rigid-boxes-export-shipping"],
  book: ["wibalin-paper-rigid-box", "book-cloth-buckram-rigid-box", "rigid-box-lid-styles-hinged-lift-off-book", "luxury-unboxing-experience-design", "custom-luxury-rigid-box-manufacturing", "book-style-vs-sleeve-tray-rigid-box"],
  inserts: ["tequila-mezcal-luxury-packaging-gift-sets", "collectible-board-game-packaging", "press-kit-packaging-launch-box", "rigid-box-drop-test-standard", "ista-3a-testing-luxury-packaging", "gin-craft-spirits-packaging-rigid-box", "hair-care-set-packaging-rigid-box", "sake-japanese-spirits-packaging", "premium-honey-gourmet-food-packaging", "incense-home-fragrance-packaging-rigid-box", "premium-pet-product-packaging", "eva-foam-insert-luxury-box", "belly-band-ribbon-wax-seal-luxury-packaging", "moulded-pulp-insert-luxury-packaging", "satin-ribbon-pull-tab-luxury-box", "tech-accessories-luxury-packaging", "box-inserts-luxury-packaging", "watch-presentation-box-custom", "jewelry-rigid-box-manufacturer-china", "jewelry-watch-rigid-box-packaging", "custom-luxury-rigid-box-manufacturing", "interior-lining-luxury-rigid-boxes", "velvet-flocked-lining-luxury-rigid-box", "eyewear-sunglasses-gift-box-packaging", "baby-shower-newborn-gift-packaging", "luxury-ceramics-tableware-gift-packaging", "premium-gourmet-food-gift-packaging", "luxury-stationery-gift-packaging", "hand-assembly-luxury-packaging", "shoe-box-footwear-gift-packaging", "corporate-award-recognition-packaging", "limited-edition-collectible-packaging", "custom-printed-tissue-paper-luxury-packaging", "pre-shipment-quality-inspection-luxury-packaging", "eva-foam-vs-moulded-pulp-insert-comparison"],
  shoppers: ["custom-luxury-paper-bag", "custom-luxury-rigid-box-manufacturing", "moq-realities-luxury-packaging"],
  bespoke: ["press-kit-packaging-launch-box", "travel-retail-luxury-packaging", "rigid-box-drop-test-standard", "find-packaging-manufacturer-startup", "ista-3a-testing-luxury-packaging", "bsci-audit-packaging-manufacturer", "luxury-packaging-gulf-market", "incoterms-packaging-imports-china", "packaging-freight-cost-china-us", "packaging-manufacturer-usa-vs-china", "moq-realities-luxury-packaging", "custom-luxury-rigid-box-manufacturing", "packaging-sample-process-china-factory", "how-to-read-rigid-box-quotation-china", "eyewear-sunglasses-gift-box-packaging", "luxury-stationery-gift-packaging", "hand-assembly-luxury-packaging", "corporate-award-recognition-packaging", "china-luxury-packaging-market-2026", "pre-shipment-quality-inspection-luxury-packaging", "flat-pack-rigid-boxes-export-shipping", "packaging-brief-calendar-2027-seasonal-launches"],
  // Surfaces
  "hot-foil": ["tequila-mezcal-luxury-packaging-gift-sets", "hanukkah-gift-box-packaging-us-brands", "collectible-board-game-packaging", "colour-consistency-offset-hot-foil-luxury-packaging", "china-national-day-2026-gift-packaging", "gin-craft-spirits-packaging-rigid-box", "korean-beauty-packaging-rigid-box", "sake-japanese-spirits-packaging", "incense-home-fragrance-packaging-rigid-box", "premium-honey-gourmet-food-packaging", "matte-lamination-hot-foil-sequence", "pantone-tolerance-luxury-packaging", "fedrigoni-paper-packaging", "gmund-paper-luxury-box", "halloween-gift-packaging-2026", "easter-spring-gift-packaging-2027", "hot-foil-stamping-process", "hot-foil-stamping-for-luxury-packaging", "hot-foil-colour-selection-luxury-packaging", "registered-emboss-foil-tolerance", "hot-foil-vs-cold-foil-cost-and-finish", "offset-vs-digital-printing-luxury-packaging", "christmas-2027-gift-packaging-calendar", "luxury-ceramics-tableware-gift-packaging", "luxury-stationery-gift-packaging", "shoe-box-footwear-gift-packaging", "limited-edition-collectible-packaging", "pre-shipment-quality-inspection-luxury-packaging", "packaging-brief-calendar-2027-seasonal-launches", "cognac-brandy-gift-box-manufacturer", "multi-color-hot-foil-stamping-rigid-box", "laser-cut-decorative-panel-rigid-box"],
  emboss: ["colour-consistency-offset-hot-foil-luxury-packaging", "deboss-blind-emboss-luxury-packaging", "registered-emboss-foil-tolerance", "hot-foil-stamping-for-luxury-packaging", "emboss-vs-deboss-luxury-packaging", "emboss-die-specification-rigid-boxes", "luxury-stationery-gift-packaging", "limited-edition-collectible-packaging", "corporate-award-recognition-packaging", "pre-shipment-quality-inspection-luxury-packaging", "laser-cut-decorative-panel-rigid-box"],
  deboss: ["deboss-blind-emboss-luxury-packaging", "wibalin-paper-rigid-box", "registered-emboss-foil-tolerance", "hot-foil-stamping-for-luxury-packaging", "emboss-vs-deboss-luxury-packaging"],
  "soft-touch": ["hair-care-set-packaging-rigid-box", "soft-touch-lamination-scratch-resistance", "matte-lamination-hot-foil-sequence", "soft-touch-vs-spot-uv-when-each-is-right", "spot-uv-luxury-rigid-box-specification", "hot-foil-stamping-for-luxury-packaging", "baby-shower-newborn-gift-packaging"],
  "spot-uv": ["spot-uv-registration-tolerance", "spot-uv-luxury-rigid-box-specification", "soft-touch-vs-spot-uv-when-each-is-right", "hot-foil-stamping-for-luxury-packaging"],
  offset: ["colour-consistency-offset-hot-foil-luxury-packaging", "serialised-qr-code-luxury-packaging", "packaging-factory-audit-checklist", "pantone-tolerance-luxury-packaging", "screen-printing-vs-foil-stamping-luxury-packaging", "soy-ink-offset-printing-luxury-packaging", "hot-foil-stamping-for-luxury-packaging", "offset-vs-digital-printing-luxury-packaging", "custom-printed-tissue-paper-luxury-packaging"],
  wraps: ["fedrigoni-paper-packaging", "gmund-paper-luxury-box", "wibalin-paper-rigid-box", "book-cloth-buckram-rigid-box", "custom-luxury-rigid-box-manufacturing", "greyboard-grades-for-luxury-rigid-construction", "post-consumer-recycled-board-luxury-packaging", "fsc-certified-rigid-box-supplier"],
  // Industries
  cosmetic: ["travel-retail-luxury-packaging", "hair-care-set-packaging-rigid-box", "korean-beauty-packaging-rigid-box", "find-packaging-manufacturer-startup", "supplement-bottle-box-manufacturer", "mens-grooming-packaging-luxury-rigid-box", "refillable-cosmetic-packaging-design", "skincare-set-packaging-manufacturer", "cosmetic-packaging-box", "custom-cosmetic-packaging-box", "perfume-bottle-with-box-packaging", "perfume-box-design-guide", "custom-luxury-gift-box", "rigid-box-cosmetic-brand", "cosmetic-packaging-luxury-rigid-box", "velvet-flocked-lining-luxury-rigid-box", "custom-printed-tissue-paper-luxury-packaging", "china-luxury-packaging-market-2026", "pre-shipment-quality-inspection-luxury-packaging", "bsci-audit-packaging-manufacturer", "eva-foam-vs-moulded-pulp-insert-comparison", "nfc-smart-packaging-luxury-rigid-box"],
  spirits: ["tequila-mezcal-luxury-packaging-gift-sets", "gin-craft-spirits-packaging-rigid-box", "sake-japanese-spirits-packaging", "premium-spirits-gift-box-manufacturer", "champagne-presentation-box-custom", "wine-champagne-gift-box-packaging", "baijiu-packaging-design-2026", "working-with-a-chinese-luxury-packaging-manufacturer", "whisky-gift-box-manufacturer", "tea-gift-box-wholesale-china", "pre-shipment-quality-inspection-luxury-packaging", "ista-3a-testing-luxury-packaging", "flat-pack-rigid-boxes-export-shipping", "cognac-brandy-gift-box-manufacturer"],
  seasonal: ["hanukkah-gift-box-packaging-us-brands", "china-national-day-2026-gift-packaging", "corporate-gifting-season-2026-rigid-box", "belly-band-ribbon-wax-seal-luxury-packaging", "mid-autumn-2026-packaging-calendar", "halloween-gift-packaging-2026", "luxury-gift-hamper-packaging", "luxury-packaging-gulf-market", "candle-gift-box-custom-packaging", "easter-spring-gift-packaging-2027", "ramadan-eid-luxury-gift-box-packaging", "advent-calendar-rigid-box-manufacturer", "diwali-gift-box-packaging", "qixi-festival-gift-packaging-2026", "dragon-boat-festival-packaging-2026", "double-11-singles-day-packaging-2026", "black-friday-gift-packaging-2026", "christmas-2027-gift-packaging-calendar", "packaging-brief-calendar-2027-seasonal-launches"],
  wellness: ["hair-care-set-packaging-rigid-box", "incense-home-fragrance-packaging-rigid-box", "premium-pet-product-packaging", "premium-honey-gourmet-food-packaging", "supplement-bottle-box-manufacturer", "premium-coffee-brand-packaging", "premium-food-brand-luxury-packaging", "packaging-carbon-footprint-scope-3", "supplement-packaging-rigid-box-guide", "moq-realities-luxury-packaging", "custom-luxury-rigid-box-manufacturing", "post-consumer-recycled-board-luxury-packaging", "baby-shower-newborn-gift-packaging", "premium-gourmet-food-gift-packaging", "fsc-certified-rigid-box-supplier", "bsci-audit-packaging-manufacturer"],
};
