...
const TOPIC_RELATED_BLOGS: Record<string, string[]> = {
  // Structures
  rigid: ["window-cutout-clear-panel-rigid-box", "luxury-gift-hamper-packaging", "premium-food-brand-luxury-packaging", "rigid-setup-box-wholesale-supplier", "paper-tube-packaging-vs-rigid-box", "two-piece-rigid-box-manufacturer", "rigid-box-manufacturer-china-low-moq", "luxury-rigid-box-price-per-unit", "fsc-certified-rigid-box-supplier", "gift-box-manufacturer-guide", "custom-luxury-rigid-box-manufacturing", "rigid-box-greyboard-weight-guide", "rigid-box-lid-styles-hinged-lift-off-book"],
  ...
  // Surfaces
  "hot-foil": ["fedrigoni-paper-packaging", "gmund-paper-luxury-box", "halloween-gift-packaging-2026", "easter-spring-gift-packaging-2027", "hot-foil-stamping-process", "hot-foil-stamping-for-luxury-packaging", "hot-foil-colour-selection-luxury-packaging", "registered-emboss-foil-tolerance", "hot-foil-vs-cold-foil-cost-and-finish"],
  ...
  "soft-touch": ["premium-food-brand-luxury-packaging", "soft-touch-vs-spot-uv-when-each-is-right", "spot-uv-luxury-rigid-box-specification", "hot-foil-stamping-for-luxury-packaging"],
