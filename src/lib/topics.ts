...
const TOPIC_RELATED_BLOGS: Record<string, string[]> = {
  ...
  magnetic: ["korean-beauty-packaging-rigid-box", "premium-pet-product-packaging", "halloween-gift-packaging-2026", "mens-grooming-packaging-luxury-rigid-box", "magnetic-gift-box-packaging", "magnetic-box-packaging", "folding-magnetic-box", "magnetic-closure-box-guide", "drawer-box-vs-magnetic-closure-luxury-packaging", "custom-magnetic-box-guide", "custom-luxury-gift-box", "black-friday-gift-packaging-2026"],
