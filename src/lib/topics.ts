...
const TOPIC_RELATED_BLOGS: Record<string, string[]> = {
  ...
  // Industries
  cosmetic: ["find-packaging-manufacturer-startup", "supplement-bottle-box-manufacturer", "mens-grooming-packaging-luxury-rigid-box", "refillable-cosmetic-packaging-design", "skincare-set-packaging-manufacturer", "cosmetic-packaging-box", "custom-cosmetic-packaging-box", "perfume-bottle-with-box-packaging", "perfume-box-design-guide", "custom-luxury-gift-box", "rigid-box-cosmetic-brand", "cosmetic-packaging-luxury-rigid-box", "velvet-flocked-lining-luxury-rigid-box"],
  ...
  wellness: ["supplement-bottle-box-manufacturer", "premium-coffee-brand-packaging", "premium-food-brand-luxury-packaging", "packaging-carbon-footprint-scope-3", "supplement-packaging-rigid-box-guide", "moq-realities-luxury-packaging", "custom-luxury-rigid-box-manufacturing", "post-consumer-recycled-board-luxury-packaging"],
};
