...
const TOPIC_RELATED_BLOGS: Record<string, string[]> = {
  // Structures
  rigid: ["window-cutout-clear-panel-rigid-box", "premium-food-brand-luxury-packaging", "rigid-setup-box-wholesale-supplier", "paper-tube-packaging-vs-rigid-box", "two-piece-rigid-box-manufacturer", "rigid-box-manufacturer-china-low-moq", "luxury-rigid-box-price-per-unit", "fsc-certified-rigid-box-supplier", "gift-box-manufacturer-guide", "custom-luxury-rigid-box-manufacturing", "rigid-box-greyboard-weight-guide", "rigid-box-lid-styles-hinged-lift-off-book"],
  magnetic: ["mens-grooming-packaging-luxury-rigid-box", "magnetic-gift-box-packaging", "magnetic-box-packaging", "folding-magnetic-box", "magnetic-closure-box-guide", "drawer-box-vs-magnetic-closure-luxury-packaging", "custom-magnetic-box-guide", "custom-luxury-gift-box"],
  ...
  // Surfaces
  "hot-foil": ["gmund-paper-luxury-box", "easter-spring-gift-packaging-2027", "hot-foil-stamping-process", "hot-foil-stamping-for-luxury-packaging", "hot-foil-colour-selection-luxury-packaging", "registered-emboss-foil-tolerance", "hot-foil-vs-cold-foil-cost-and-finish"],
  ...
  wraps: ["gmund-paper-luxury-box", "wibalin-paper-rigid-box", "book-cloth-buckram-rigid-box", "custom-luxury-rigid-box-manufacturing", "greyboard-grades-for-luxury-rigid-construction"],
  // Industries
  ...
  seasonal: ["candle-gift-box-custom-packaging", "easter-spring-gift-packaging-2027", "ramadan-eid-luxury-gift-box-packaging", "advent-calendar-rigid-box-manufacturer", "diwali-gift-box-packaging", "qixi-festival-gift-packaging-2026", "dragon-boat-festival-packaging-2026", "double-11-singles-day-packaging-2026"],
  wellness: ["supplement-bottle-box-manufacturer", "premium-food-brand-luxury-packaging", "packaging-carbon-footprint-scope-3", "supplement-packaging-rigid-box-guide", "moq-realities-luxury-packaging", "custom-luxury-rigid-box-manufacturing"],
};
