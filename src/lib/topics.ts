...
const TOPIC_COPY: Record<string, TopicCopy> = {
  ...
  magnetic: {
    ...
    commercialDescription: "Luxury packaging magnet pull force: 6–50 g at 2,800 Gauss, tuned to lid weight. MOQ 200+, 7–10 day samples, 24–32 day production. Magnet hidden under wrap.",
    buyerFaq: [
...
const TOPIC_RELATED_BLOGS: Record<string, string[]> = {
  ...
  emboss: ["colour-consistency-offset-hot-foil-luxury-packaging", "deboss-blind-emboss-luxury-packaging", "registered-emboss-foil-tolerance", "hot-foil-stamping-for-luxury-packaging", "emboss-vs-deboss-luxury-packaging", "emboss-die-specification-rigid-boxes"],
  ...
  "soft-touch": ["hair-care-set-packaging-rigid-box", "soft-touch-lamination-scratch-resistance", "matte-lamination-hot-foil-sequence", "soft-touch-vs-spot-uv-when-each-is-right", "spot-uv-luxury-rigid-box-specification", "hot-foil-stamping-for-luxury-packaging"],
