...
const TOPIC_RELATED_BLOGS: Record<string, string[]> = {
  ...
  "soft-touch": ["soft-touch-lamination-scratch-resistance", "matte-lamination-hot-foil-sequence", "soft-touch-vs-spot-uv-when-each-is-right", "spot-uv-luxury-rigid-box-specification", "hot-foil-stamping-for-luxury-packaging"],
  ...
  offset: ["serialised-qr-code-luxury-packaging", "packaging-factory-audit-checklist", "pantone-tolerance-luxury-packaging", "screen-printing-vs-foil-stamping-luxury-packaging", "soy-ink-offset-printing-luxury-packaging", "hot-foil-stamping-for-luxury-packaging", "offset-vs-digital-printing-luxury-packaging"],
  ...
  // Industries
  cosmetic: ["korean-beauty-packaging-rigid-box", "find-packaging-manufacturer-startup", "supplement-bottle-box-manufacturer", "mens-grooming-packaging-luxury-rigid-box", "refillable-cosmetic-packaging-design", "skincare-set-packaging-manufacturer", "cosmetic-packaging-box", "custom-cosmetic-packaging-box", "perfume-bottle-with-box-packaging", "perfume-box-design-guide", "custom-luxury-gift-box", "rigid-box-cosmetic-brand", "cosmetic-packaging-luxury-rigid-box", "velvet-flocked-lining-luxury-rigid-box"],
  spirits: ["sake-japanese-spirits-packaging", "premium-spirits-gift-box-manufacturer", "champagne-presentation-box-custom", "wine-champagne-gift-box-packaging", "baijiu-packaging-design-2026", "working-with-a-chinese-luxury-packaging-manufacturer", "whisky-gift-box-manufacturer", "tea-gift-box-wholesale-china"],
  seasonal: ["corporate-gifting-season-2026-rigid-box", "belly-band-ribbon-wax-seal-luxury-packaging", "mid-autumn-2026-packaging-calendar", "halloween-gift-packaging-2026", "luxury-gift-hamper-packaging", "luxury-packaging-gulf-market", "candle-gift-box-custom-packaging", "easter-spring-gift-packaging-2027", "ramadan-eid-luxury-gift-box-packaging", "advent-calendar-rigid-box-manufacturer", "diwali-gift-box-packaging", "qixi-festival-gift-packaging-2026", "dragon-boat-festival-packaging-2026", "double-11-singles-day-packaging-2026", "black-friday-gift-packaging-2026"],
  wellness: ["incense-home-fragrance-packaging-rigid-box", "premium-pet-product-packaging", "premium-honey-gourmet-food-packaging", "supplement-bottle-box-manufacturer", "premium-coffee-brand-packaging", "premium-food-brand-luxury-packaging", "packaging-carbon-footprint-scope-3", "supplement-packaging-rigid-box-guide", "moq-realities-luxury-packaging", "custom-luxury-rigid-box-manufacturing", "post-consumer-recycled-board-luxury-packaging"],
};
