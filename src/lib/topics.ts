...
const TOPIC_RELATED_BLOGS: Record<string, string[]> = {
  // Structures
  rigid: ["ecommerce-subscription-box-manufacturer", "window-cutout-clear-panel-rigid-box", "luxury-gift-hamper-packaging", "premium-food-brand-luxury-packaging", "rigid-setup-box-wholesale-supplier", "paper-tube-packaging-vs-rigid-box", "two-piece-rigid-box-manufacturer", "rigid-box-manufacturer-china-low-moq", "luxury-rigid-box-price-per-unit", "fsc-certified-rigid-box-supplier", "gift-box-manufacturer-guide", "custom-luxury-rigid-box-manufacturing", "rigid-box-greyboard-weight-guide", "rigid-box-lid-styles-hinged-lift-off-book", "black-friday-gift-packaging-2026", "how-to-read-rigid-box-quotation-china"],
  ...
  "soft-touch": ["soft-touch-lamination-scratch-resistance", "premium-food-brand-luxury-packaging", "soft-touch-vs-spot-uv-when-each-is-right", "spot-uv-luxury-rigid-box-specification", "hot-foil-stamping-for-luxury-packaging"],
  ...
  offset: ["packaging-factory-audit-checklist", "pantone-tolerance-luxury-packaging", "screen-printing-vs-foil-stamping-luxury-packaging", "soy-ink-offset-printing-luxury-packaging", "hot-foil-stamping-for-luxury-packaging", "offset-vs-digital-printing-luxury-packaging"],
