...
const TOPIC_RELATED_BLOGS: Record<string, string[]> = {
  ...
  bespoke: ["luxury-packaging-gulf-market", "incoterms-packaging-imports-china", "packaging-freight-cost-china-us", "packaging-manufacturer-usa-vs-china", "moq-realities-luxury-packaging", "custom-luxury-rigid-box-manufacturing", "packaging-sample-process-china-factory"],
  // Surfaces
  ...
  deboss: ["wibalin-paper-rigid-box", "registered-emboss-foil-tolerance", "hot-foil-stamping-for-luxury-packaging", "emboss-vs-deboss-luxury-packaging"],
  ...
  offset: ["pantone-tolerance-luxury-packaging", "screen-printing-vs-foil-stamping-luxury-packaging", "soy-ink-offset-printing-luxury-packaging", "hot-foil-stamping-for-luxury-packaging"],
  ...
  // Industries
  cosmetic: ["supplement-bottle-box-manufacturer", "mens-grooming-packaging-luxury-rigid-box", "refillable-cosmetic-packaging-design", "skincare-set-packaging-manufacturer", "cosmetic-packaging-box", "custom-cosmetic-packaging-box", "perfume-bottle-with-box-packaging", "perfume-box-design-guide", "custom-luxury-gift-box", "rigid-box-cosmetic-brand", "cosmetic-packaging-luxury-rigid-box"],
