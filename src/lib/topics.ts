...
const TOPIC_RELATED_BLOGS: Record<string, string[]> = {
  ...
  wraps: ["fedrigoni-paper-packaging", "gmund-paper-luxury-box", "wibalin-paper-rigid-box", "book-cloth-buckram-rigid-box", "custom-luxury-rigid-box-manufacturing", "greyboard-grades-for-luxury-rigid-construction", "post-consumer-recycled-board-luxury-packaging"],
  // Industries
